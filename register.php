    ...
    <body>
        ...
        <div class="jumbotron">
            <table class="table table-striped table-bordered">
                <tr><th>No</th><th>ID</th><th>Name</th><th>Password</th></tr>
                <?php
                ...
                {?>
                <tr><td><?php echo $row['no']?></td><td><?php echo $row['id']?></td><td><?php echo $row['name']?></td><td><?php echo $row['password']?></td></tr>
                <?php } ?>
            </table>
        </div> 
